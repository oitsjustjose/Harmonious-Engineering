onEvent('recipes', event => {
  ...
  const expandedstorage = () => {
    ...
    [
      ...
      'expandedstorage:copper_mini_barrel_with_sparrow',
      'expandedstorage:diamond_mini_barrel_with_sparrow',
      'expandedstorage:diamond_mini_chest_with_sparrow',
      'expandedstorage:exposed_copper_mini_barrel_with_sparrow',
      'expandedstorage:gold_mini_barrel_with_sparrow',
      'expandedstorage:gold_mini_chest_with_sparrow',
      'expandedstorage:green_mini_present_with_sparrow',
      'expandedstorage:green_mini_present',
      'expandedstorage:iron_mini_barrel_with_sparrow',
      'expandedstorage:iron_mini_chest_with_sparrow',
      'expandedstorage:lavender_mini_present_with_sparrow',
      'expandedstorage:lavender_mini_present',
      'expandedstorage:mini_barrel_with_sparrow',
      'expandedstorage:netherite_mini_barrel_with_sparrow',
      'expandedstorage:netherite_mini_chest_with_sparrow',
      'expandedstorage:obsidian_mini_barrel_with_sparrow',
      'expandedstorage:obsidian_mini_chest_with_sparrow',
      ...
      'expandedstorage:oxidized_copper_mini_barrel_with_sparrow',
      ...
      'expandedstorage:waxed_copper_mini_barrel_with_sparrow',
      'expandedstorage:waxed_exposed_copper_mini_barrel_with_sparrow',
      'expandedstorage:waxed_oxidized_copper_mini_barrel_with_sparrow',
      'expandedstorage:waxed_weathered_copper_mini_barrel_with_sparrow',
      'expandedstorage:weathered_copper_mini_barrel_with_sparrow',
