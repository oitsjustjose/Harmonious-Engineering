onEvent("recipes", (event) => {
  ...
  tconWoods.forEach((woodType) => {
    ...
    global.genNatProgRecipes(woodType.log, woodType.strippedLog, woodType.plank).forEach((x) => event.custom(x));
    global.genNatProgRecipes(woodType.wood, woodType.strippedWood, woodType.plank).forEach((x) => event.custom(x));
  });
});
