onEvent("recipes", (event) => {
  ...
  global.genAlloyingRecipe(event, { item: `${modid}:draconium_ingot` }, { tag: "forge:obsidian" }, `${modid}:infused_obsidian`, 1);
  ...
  global.genCombinedRecipe(event, Ingredient.of("modularrouters:augment_core"), Ingredient.of(`${modid}:draconium_ingot`), Item.of(`${modid}:module_core`));
