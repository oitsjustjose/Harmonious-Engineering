onEvent("recipes", (event) => {
  ...
  event.shaped(
    "1x mekanism:module_attack_amplification_unit",
    ["I#I", "IAI", "PPP"],
    {
  ...
  event.shaped(
    "1x mekanism:module_charge_distribution_unit",
    ["I#I", "IAI", "PPP"],
    {
  ...
  event.shaped(
    "1x mekanism:module_electrolytic_breathing_unit",
    ["I#I", "IAI", "PPP"],
    {
      I: "#forge:alloys/advanced",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_excavation_escalation_unit",
    ["I#I", "IAI", "PPP"],
    {
      I: "#forge:alloys/advanced",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_hydraulic_propulsion_unit",
    ["I#I", "EAE", "PPP"],
    {
      I: "#forge:alloys/elite",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_inhalation_purification_unit",
    ["I#I", "IAI", "PoP"],
    {
      I: "#forge:alloys/elite",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_magnetic_attraction_unit",
    ["I#I", "CAC", "PPP"],
    {
      I: "#forge:alloys/elite",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_nutritional_injection_unit",
    ["I#I", "IAI", "PPP"],
    {
      I: "#forge:alloys/elite",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_radiation_shielding_unit",
    ["I#I", "IAI", "PPP"],
    {
      I: "#forge:alloys/advanced",
      A: "mekanism:module_base",
  ...
  event.shaped(
    "1x mekanism:module_vision_enhancement_unit",
    ["I#I", "IAI", "PPP"],
    {
      I: "#forge:alloys/elite",
      A: "mekanism:module_base",
