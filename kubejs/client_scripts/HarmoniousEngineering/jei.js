onEvent('jei.hide.items', event => {
  [
    ...
    'extcaves:butcher_knife',
    'extcaves:chef_knife',
    'extcaves:gourmet_fork',
    'extcaves:gourmet_spoon',
    'extcaves:iron_dagger',
    'extcaves:pebble_andesite',
    'extcaves:pebble_diorite',
    'extcaves:pebble_granite',
    'extcaves:pebble_lavastone',
    'extcaves:pebble_sedimentstone',
    'extcaves:pebble_stone',
    'extcaves:picker_flint',
    'extcaves:picker_stone',
    'extcaves:rock_flint',
    'extcaves:rock_pebble_andesite',
    'extcaves:rock_pebble_diorite',
    'extcaves:rock_pebble_granite',
    'extcaves:rock_pebble_lavastone',
    'extcaves:rock_pebble_sedimentstone',
    'extcaves:rock_pebble_stone',
    'extcaves:rock_stalactite_andesite',
    'extcaves:rock_stalactite_diorite',
    'extcaves:rock_stalactite_granite',
    'extcaves:rock_stalactite_lavastone',
    'extcaves:rock_stalactite_packed_ice',
    'extcaves:rock_stalactite_sedimentstone',
    'extcaves:rock_stalactite_stone',
    'extcaves:rock_stalactite_tall_andesite',
    'extcaves:rock_stalactite_tall_diorite',
    'extcaves:rock_stalactite_tall_granite',
    'extcaves:rock_stalactite_tall_lavastone',
    'extcaves:rock_stalactite_tall_packed_ice',
    'extcaves:rock_stalactite_tall_sedimentstone',
    'extcaves:rock_stalactite_tall_stone',
    'extcaves:rock_stalagmite_andesite',
    'extcaves:rock_stalagmite_diorite',
    'extcaves:rock_stalagmite_granite',
    'extcaves:rock_stalagmite_lavastone',
    'extcaves:rock_stalagmite_packed_ice',
    'extcaves:rock_stalagmite_sedimentstone',
    'extcaves:rock_stalagmite_stone',
    'extcaves:rock_stalagmite_tall_andesite',
    'extcaves:rock_stalagmite_tall_diorite',
    'extcaves:rock_stalagmite_tall_granite',
    'extcaves:rock_stalagmite_tall_lavastone',
    'extcaves:rock_stalagmite_tall_packed_ice',
    'extcaves:rock_stalagmite_tall_sedimentstone',
    'extcaves:rock_stalagmite_tall_stone',
    'extcaves:rockpile_three_andesite',
    'extcaves:rockpile_three_diorite',
    'extcaves:rockpile_three_granite',
    'extcaves:rockpile_three_lavastone',
    'extcaves:rockpile_three_sedimentstone',
    'extcaves:rockpile_three_stone',
    'extcaves:rockpile_two_andesite',
    'extcaves:rockpile_two_diorite',
    'extcaves:rockpile_two_granite',
    'extcaves:rockpile_two_lavastone',
    'extcaves:rockpile_two_sedimentstone',
    'extcaves:rockpile_two_stone',
    'extcaves:rusty_pickaxe',
    'extcaves:rusty_sword',
    'extcaves:wooden_cane',
